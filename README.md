...
The contents of the validate and test properties are the shell commands to be run to perform those functions. Having these specified in your package.json also
